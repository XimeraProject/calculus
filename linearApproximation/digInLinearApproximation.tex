...
\begin{example}
	...
	\begin{tikzpicture}
		\begin{axis}[
	          ...
	          \addplot [thick, penColor, smooth] {3*sqrt(x)-2};
...
\begin{tikzpicture}
  ...
  trim axis right,            
	  ...
	  \addplot [draw=black,dashed,->,>=stealth'] plot coordinates {(1.7,10/6) (1.7,10/6 +.3/.36)};
          \addplot [very thick,penColor, smooth,samples=100,domain=(1:1.833)] {-1/(x-2)};
            \addplot [very thick,penColor2, smooth,samples=100,domain=(1:1.833)] {1/0.6+(1/0.36)*(x-1.4)};
  ...
  \begin{image}
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot [very thick, penColor, samples=150,smooth] {x^(1/3)};
        ...
        \addplot [draw=black,dashed,->,>=stealth'] plot coordinates {(64,4) (50, 4)};
         \addplot [very thick, penColor2] {x/48+8/3};
...
\begin{tikzpicture}
	\begin{axis}[
          ...
          \addplot [ thick, penColor, samples=100,smooth] {sin(deg(x))};
